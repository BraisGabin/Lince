 ...
 * @author Brais
 */
public class Faster extends Command {

    private Reproductor reproductor;
    private static Observable observable = new MyObservable();

    public Faster(Reproductor reproductor) {
        this.reproductor = reproductor;
        //putValue(Action.NAME, "Más rapido");
        putValue(Action.ACTION_COMMAND_KEY, "MasRapido");
        putValue(Action.SHORT_DESCRIPTION, java.util.ResourceBundle.getBundle("i18n.Bundle").getString("MÁS RÁPIDO"));
        putValue(Action.LARGE_ICON_KEY, new ImageIcon(getClass().getResource("/iconos/x32/player_fwd.png")));
    }
    ...
    public void execute() {
        ...
        if (f < 1) {
            ...
            // TODO: mostrar velocidad demasiado alta
        }
