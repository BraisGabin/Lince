 ...
 */
package lince.controladores.calidad;
...
import lince.calidad.CalidadDelDatoMainPanel;
...
public class AbrirCalcularKappa extends Command {
    ...
    @Override
    public void execute() {
        JDialog calidadDelDato = new JDialog(LinceFrame.getInstance(), java.util.ResourceBundle.getBundle("i18n.Bundle").getString("CALIDAD DEL DATO"), JDialog.DEFAULT_MODALITY_TYPE);
